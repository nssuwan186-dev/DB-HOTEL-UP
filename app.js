...
let bookings = [];
let customers = [
    { id: 1, customerId: 'CM01155', name: 'ชัชพล หลวงชา', email: '-', phone: '091-8673-787', visits: 1, totalSpent: 400, status: 'active' },
    { id: 2, customerId: 'CM01156', name: 'คุณปอนด์', email: '-', phone: '06-2414-378', visits: 2, totalSpent: 800, status: 'active' },
    { id: 3, customerId: 'CM01157', name: 'เพลง', email: '-', phone: '081-9524-051', visits: 1, totalSpent: 400, status: 'active' },
    { id: 4, customerId: 'CM01158', name: 'โสภณ', email: '-', phone: '083-7257-244', visits: 3, totalSpent: 1200, status: 'active' },
    { id: 5, customerId: 'CM01159', name: 'บริษัท โชวี่', email: '-', phone: '081-7369-113', visits: 5, totalSpent: 2500, status: 'vip' },
    { id: 6, customerId: 'CM01160', name: 'คุณส้ม', email: '-', phone: '065-9208-391', visits: 1, totalSpent: 500, status: 'active' },
    { id: 7, customerId: 'CM01161', name: 'เต้', email: '-', phone: '088-2744-477', visits: 2, totalSpent: 1000, status: 'active' },
    { id: 8, customerId: 'CM01162', name: 'อธิวัฒน์ ยาทองไชย', email: '-', phone: '063-5250-916', visits: 1, totalSpent: 400, status: 'active' },
    { id: 9, customerId: 'CM01163', name: 'พัชรินทร์', email: '-', phone: '080-2104-363', visits: 4, totalSpent: 1600, status: 'active' },
    { id: 10, customerId: 'CM01165', name: 'กำธร โพธิ์เสน', email: '-', phone: '089-5305-462', visits: 1, totalSpent: 500, status: 'active' },
    { id: 11, customerId: 'CM01166', name: 'คุณเป๊ก', email: '-', phone: '065-1193-844', visits: 2, totalSpent: 800, status: 'active' },
    { id: 12, customerId: 'CM01167', name: 'พิชิตชัย', email: '-', phone: '080-0138-270', visits: 3, totalSpent: 1500, status: 'active' },
    { id: 13, customerId: 'CM01125', name: 'คุณ พีระ ตรีบวรกุศล', email: '-', phone: '085-6672-260', visits: 1, totalSpent: 600, status: 'active' },
    { id: 14, customerId: 'CM01169', name: 'บรรเจิด หอยทอง', email: '-', phone: '081-4410-591', visits: 2, totalSpent: 1000, status: 'active' },
    { id: 15, customerId: 'CM01170', name: 'สมภพ โชติวงษ์', email: '-', phone: '089-2087-259', visits: 1, totalSpent: 500, status: 'active' },
    { id: 16, customerId: 'CM01171', name: 'คุณสุพัตรา', email: '-', phone: '099-4526-649', visits: 4, totalSpent: 2000, status: 'active' },
    { id: 17, customerId: 'CM01172', name: 'ลุงเลียม', email: '-', phone: '088-7479-892', visits: 5, totalSpent: 2500, status: 'vip' },
    { id: 18, customerId: 'CM01173', name: 'วิชิต', email: '-', phone: '093-1011-156', visits: 1, totalSpent: 400, status: 'active' },
    { id: 19, customerId: 'CM01174', name: 'น้องฟ้า', email: '-', phone: '080-1805-376', visits: 2, totalSpent: 800, status: 'active' },
    { id: 20, customerId: 'CM01175', name: 'ธีรพงษ์', email: '-', phone: '080-4651-451', visits: 3, totalSpent: 1500, status: 'active' },
    { id: 21, customerId: 'CM01178', name: 'สำเริง เดือนคล้อย', email: '-', phone: '089-2542-788', visits: 1, totalSpent: 400, status: 'active' },
    { id: 22, customerId: 'CM01179', name: 'จิณิพงษ์ ละการชั่ว', email: '-', phone: '080-2454-323', visits: 1, totalSpent: 400, status: 'active' },
    { id: 23, customerId: 'CM01180', name: 'ธาราวุธ', email: '-', phone: '082-2698-388', visits: 1, totalSpent: 500, status: 'active' },
    { id: 24, customerId: 'CM01181', name: 'จีระเดช แข็งขัน', email: '-', phone: '064-0100-598', visits: 2, totalSpent: 800, status: 'active' },
    { id: 25, customerId: 'CM01182', name: 'นายวิทยา ชัยระเทศ', email: '-', phone: '064-9929-890', visits: 3, totalSpent: 1200, status: 'active' },
    { id: 26, customerId: 'CM01183', name: 'ชญานิศ ชินใหม่', email: '-', phone: '063-0290-136', visits: 1, totalSpent: 400, status: 'active' },
    { id: 27, customerId: 'CM01184', name: 'สุกัญญา', email: '-', phone: '096-5306-618', visits: 2, totalSpent: 800, status: 'active' },
    { id: 28, customerId: 'CM01185', name: 'ชัยศักดิ์ อัดตละ', email: '-', phone: '089-3977-374', visits: 4, totalSpent: 2000, status: 'active' },
    { id: 29, customerId: 'CM01186', name: 'ภณัชกร', email: '-', phone: '099-2564-837', visits: 1, totalSpent: 500, status: 'active' },
    { id: 30, customerId: 'CM01188', name: 'บริษัท ชัวร์ ฟิลเตอร์ (ประเทศไทย) จำกัด', email: '-', phone: '745546000078', visits: 10, totalSpent: 5000, status: 'vip' },
    { id: 31, customerId: 'CM01189', name: 'วิญญู', email: '-', phone: '082-8500-850', visits: 2, totalSpent: 1000, status: 'active' },
    { id: 32, customerId: 'CM01193', name: 'บริษัท ดี.เอช.เอ.สยามวาลา จำกัด', email: '-', phone: '105485000257', visits: 8, totalSpent: 4000, status: 'vip' },
    { id: 33, customerId: 'CM01195', name: 'ปณต โพธิ์สว่าง', email: '-', phone: '093-5435-843', visits: 1, totalSpent: 500, status: 'active' },
    { id: 34, customerId: 'CM01196', name: 'สุจิตรา ธรรมเจริญ', email: '-', phone: '092-8875-964', visits: 3, totalSpent: 1200, status: 'active' },
    { id: 35, customerId: 'CM01198', name: 'วินัย', email: '-', phone: '080-7710-888', visits: 1, totalSpent: 400, status: 'active' },
    { id: 36, customerId: 'CM01202', name: 'วงศ์วรัญ นารถชัย', email: '-', phone: '095-205-2957', visits: 2, totalSpent: 1000, status: 'active' },
    { id: 37, customerId: 'CM01203', name: 'บริษัท เค เทคนิคเชี่ยน แอนด์ เซอร์วิส จำกัด', email: '-', phone: '135557015433', visits: 6, totalSpent: 3000, status: 'vip' },
    { id: 38, customerId: 'CM01204', name: 'บริษัท ห้าม้า โอสถ จำกัด', email: '-', phone: '105546034385', visits: 5, totalSpent: 2500, status: 'vip' },
    { id: 39, customerId: 'CM01206', name: 'ครูยา', email: '-', phone: '081-0540-830', visits: 1, totalSpent: 400, status: 'active' },
    { id: 40, customerId: 'CM01208', name: 'ยุทธพงษ์', email: '-', phone: '062-5782-534', visits: 2, totalSpent: 800, status: 'active' },
    { id: 41, customerId: 'CM01211', name: 'จุติพร เทยเลอร์', email: '-', phone: '080-7014-582', visits: 1, totalSpent: 600, status: 'active' },
    { id: 42, customerId: 'CM01220', name: 'บริษัท ออโตคอร์ป โฮลดิ้ง จำกัด', email: '-', phone: '325558000225', visits: 4, totalSpent: 2400, status: 'vip' },
    { id: 43, customerId: 'CM01227', name: 'น.ส. ชนิทณี เดชบุรีรัมธ', email: '-', phone: '086-3403-382', visits: 1, totalSpent: 400, status: 'active' },
    { id: 44, customerId: 'CM01237', name: 'ลลิตา', email: '-', phone: '064-3364-251', visits: 2, totalSpent: 800, status: 'active' },
    { id: 45, customerId: 'CM01256', name: 'วัฒนา สีอ่อง', email: '-', phone: '080-2372-464', visits: 1, totalSpent: 500, status: 'active' },
];
